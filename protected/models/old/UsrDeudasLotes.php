...
/**
 * This is the model class for table "usr_deudas_lotes".
 *
 * The followings are the available columns in table 'usr_deudas_lotes':
 * @property integer $id
 ...
 */
class UsrDeudasLotes extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('identidad, oferta1_qcuotas, oferta1_porcentaje_quita, oferta2_qcuotas, oferta2_porcentaje_quita, oferta3_qcuotas, oferta3_porcentaje_quita, oferta4_qcuotas, oferta4_porcentaje_quita, oferta5_qcuotas, oferta5_porcentaje_quita, idusuario_carga, idestadoregistro', 'numerical', 'integerOnly'=>true),
			...
			array('oferta1_montocuota, oferta2_montocuota, oferta3_montocuota, oferta4_montocuota, oferta5_montocuota', 'length', 'max'=>11),
			array('validacion1_respuesta_valida, validacion2_respuesta_valida, validacion3_respuesta_valida, validacion4_respuesta_valida, validacion5_respuesta_valida, adicional01, adicional02, adicional03, adicional04, adicional05', 'length', 'max'=>30),
	 ...
	 * @return UsrDeudasLotes the static model class
	 */
