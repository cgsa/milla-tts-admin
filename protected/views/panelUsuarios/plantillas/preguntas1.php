...
<?php $form=$this->beginWidget('CActiveForm', array(
  ...
  <div class="form-group">
    <div class="form-row">
      ...
      <div class="col-md-11">            
            ...
            ?>
                <div class="radio">
                  <label><input type="radio" value="4" name="UsrDeudas[repuesta1]"><?php echo $model->validacion1_respuesta_erronea_3;?></label>
            ...
            ?>
                <div class="radio">
                  <label><input type="radio" value="2" name="UsrDeudas[repuesta1]"><?php echo $model->validacion1_respuesta_erronea_1;?></label>
                </div>
            <?php 
            endif;
            ?>
            ...
            ?>
                <div class="radio">
                  <label><input type="radio" value="3" name="UsrDeudas[repuesta1]"><?php echo $model->validacion1_respuesta_valida;?></label>
                </div>
            <?php 
            endif;
            ?>
            ...
            ?>
                <div class="radio">
                  <label><input type="radio" value="4" name="UsrDeudas[repuesta1]"><?php echo $model->validacion1_respuesta_erronea_2;?></label>
                </div>
            <?php 
            endif;
            ?>
            ...
            ?>
                <div class="radio">
                  <label><input type="radio" value="5" name="UsrDeudas[repuesta1]">
  ...
  <div class="form-group">
    <div class="form-row">
      ...
      <div class="col-md-11">            
            ...
            ?>
                <div class="radio">
                  <label><input type="radio" value="1" name="UsrDeudas[repuesta2]">
            ...
            ?>
                <div class="radio">
                  <label><input type="radio" value="2" name="UsrDeudas[repuesta2]"><?php echo $model->validacion2_respuesta_erronea_2;?></label>
                </div>
            <?php 
            endif;
            ?>
            ...
            ?>
                <div class="radio">
                  <label><input type="radio" value="3" name="UsrDeudas[repuesta2]"><?php echo $model->validacion2_respuesta_erronea_1;?></label>
                </div>
            <?php 
            endif;
            ?>
            ...
            ?>
                <div class="radio">
                  <label><input type="radio" value="4" name="UsrDeudas[repuesta2]"><?php echo $model->validacion2_respuesta_erronea_3;?></label>
                </div>
            <?php 
            endif;
            ?>
            ...
            ?>
                <div class="radio">
                  <label><input type="radio" value="5" name="UsrDeudas[repuesta2]"><?php echo $model->validacion2_respuesta_valida;?></label>
                </div>
            <?php 
            endif;
            ?>
  ...
  <div class="form-group">
    <div class="form-row">
      ...
      <div class="col-md-11">            
            ...
            ?>
                <div class="radio">
                  <label><input type="radio" value="1" name="UsrDeudas[repuesta3]">
            ...
            ?>
                <div class="radio">
                  <label><input type="radio" value="2" name="UsrDeudas[repuesta3]"><?php echo $model->validacion3_respuesta_valida;?></label>
                </div>
            <?php 
            endif;
            ?>
            ...
            ?>
                <div class="radio">
                  <label><input type="radio" value="3" name="UsrDeudas[repuesta3]">
            ...
            ?>
                <div class="radio">
                  <label><input type="radio" value="4" name="UsrDeudas[repuesta3]"><?php echo $model->validacion3_respuesta_erronea_2;?></label>
                </div>
            <?php 
            endif;
            ?>
            ...
            ?>
                <div class="radio">
                  <label><input type="radio" value="5" name="UsrDeudas[repuesta3]"><?php echo $model->validacion3_respuesta_erronea_1;?></label>
                </div>
            <?php 
            endif;
            ?>
  ...
  <div class="form-group">
    <div class="form-row">
      ...
      <div class="col-md-11">            
            ...
            ?>
                <div class="radio">
                  <label><input type="radio" value="2" name="UsrDeudas[respuesta4]"><?php echo $model->validacion4_respuesta_erronea_3;?></label>
                </div>
            <?php 
            endif;
            ?>
            ...
            ?>
                <div class="radio">
                  <label><input type="radio" value="4" name="UsrDeudas[respuesta4]"><?php echo $model->validacion4_respuesta_valida;?></label>
                </div>
            <?php 
            endif;
            ?>
            ...
            ?>
                <div class="radio">
                  <label><input type="radio" value="5" name="UsrDeudas[respuesta4]"><?php echo $model->validacion4_respuesta_erronea_4;?></label>
                </div>
            <?php 
            endif;
            ?>
  ...
  <div class="form-group">
    <div class="form-row">
      ...
      <div class="col-md-11">            
            ...
            ?>
                <div class="radio">
                  <label><input type="radio" value="3" name="UsrDeudas[respuesta5]">
            ...
            ?>
                <div class="radio">
                  <label><input type="radio" value="4" name="UsrDeudas[respuesta5]"><?php echo $model->validacion5_respuesta_erronea_1;?></label>
                </div>
            <?php 
            endif;
            ?>
            ...
            ?>
                <div class="radio">
                  <label><input type="radio" value="5" name="UsrDeudas[respuesta5]"><?php echo $model->validacion5_respuesta_erronea_3;?></label>
                </div>
            <?php 
            endif;
            ?>
  ...
  <div class="form-group">
    <div class="form-row">
      ...
      <div class="col-md-2">
      	<?php echo CHtml::submitButton('Validar',array('class'=>'btn btn-primary btn_validar_usuario')); ?>
      </div>
   	</div>
  </div>  
<?php $this->endWidget(); ?>
