...
<body class="sticky-footer bg-light" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg static-top navbar-light bg-light" id="mainNav">
    <a class="navbar-brand" href="<?php echo Yii::app()->createUrl('PanelUsuarios/index');?>">
  ...
  <div class="content-wrapper">
    ...
    <script type="text/javascript" src="<?php echo $baseUrl; ?>/assets/8c8cd6f4/jquery.js"></script>
