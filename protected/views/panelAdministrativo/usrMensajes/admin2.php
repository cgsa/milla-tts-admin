                        	...
                        	<div class="tab-pane active" id="1">
                                  ...
                                  <thead>
                                    <?php 
                                  	...
                                  	$criteria->condition = "estadomensaje = 0 AND tipo = 2";
                                  	...
                                  	?>
                                        <tr data-control="txtEstados<?php echo $value->estadomensaje;?>" title="Abrir Mensaje" data-status="<?php echo $value->estadomensaje;?>"  data-tipo="<?php echo $value->tipo;?>" data-action="U" data-id="<?php echo $value->id;?>" >
                                          ...
                                          <td><?php echo date("d-m-Y", strtotime($value->fecha_carga));?></td>
                                        </tr>
                                    <?php 
                                    endforeach;
                                    ?>
                            	...
                            	<table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                  <thead>
                                    <?php 
                                  	...
                                  	$criteria=new CDbCriteria;
                                  	$criteria->condition = "estadomensaje = 2 AND tipo = 2";
                                  	$rows = $model->findAll($criteria);
                          	...
                          	<div class="tab-pane" id="3">
                                  ...
                                  <thead>
                                    <?php 
                                  	...
                                  	$criteria=new CDbCriteria;
                                  	$criteria->condition = "estadomensaje = 6 AND tipo = 2";
                                  	$rows = $model->findAll($criteria);
