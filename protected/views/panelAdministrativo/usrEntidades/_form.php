        	...
        	<div class="form-group">
                <div class="form-row">
                  <div class="col-md-6">
            		...
            		<?php 
            		echo $form->dropDownList($model,'idestadoentidad',array('1' => 'Clientes', '2' => 'No clientes', '0' => 'Inactivo'),
            ...
            <div class="form-group">
                <div class="form-row">
                  <div class="col-md-6">
            		...
            		<?php echo $form->textField($model,'codigo_url',array('size'=>50,'maxlength'=>15,'class'=>'form-control')); ?>
            		<?php echo $form->error($model,'codigo_url'); ?>             		
                  </div>
                  <div class="col-md-6">
                    <?php echo $form->labelEx($model,'codapi'); ?>
            		<?php echo $form->textField($model,'codapi',array('size'=>50,'maxlength'=>15,'class'=>'form-control')); ?>
            		<?php echo $form->error($model,'codapi'); ?>             		
                  </div>
                </div>
            </div>
            <div class="form-group">
