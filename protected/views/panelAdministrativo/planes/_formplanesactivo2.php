...
<div class="modal-dialog" >
    <div class="modal-content">
      ...
      <?php $form=$this->beginWidget('CActiveForm', array(
        ...
        <input type="hidden" id="action" name="action" value="UPP">
        	...
        	<div class="form-group">
                <div class="form-row">
                  <div class="col-md-12">
            		...
            		<?php 
            		      $list = CHtml::listData(Planes::model()->findAll(array('order' => 'nombre')),'id', 'nombre');
            		      echo $form->dropDownList($model,'idplan',$list,
        	...
        	<div class="form-group">
                <div class="form-row">
                	<div class="col-md-12">        		
            			...
            			<dl> 
            				<?php 
                        	$array = json_decode($model->config_json);
                        	//var_dump($array->config);die;
                        	foreach($array->config as $key=>$value):
                        	?>
                      			<dt class='col-sm-6'><?php echo $key;?></dt>
                      			<dd class='col-sm-6'><input type='text' class='form-control' autocomplete="off" name='config[<?php echo $key;?>]' value='<?php echo $value;?>' maxlength="100" /></dd>
                      		<?php 
                            endforeach;
                            ?>               
                        </dl>              		
