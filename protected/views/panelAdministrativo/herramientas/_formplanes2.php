...
<div class="modal-dialog" >
    <div class="modal-content">
      ...
      //'htmlOptions' => array('enctype' => 'multipart/form-data'),
        ...
        <input type="hidden" id="Planes_idherramienta" name="Planes[idherramienta]" value="<?php echo $model->idherramienta; ?>">
        <input type="hidden" id="Planes_id" name="Planes[id]" value="<?php echo $model->id; ?>">
      ...
      <div class="modal-body">
      	<div class="row" >
      		...
      		<div class="form-group">
                <div class="form-row">
                  <div class="col-md-12">
                    <?php echo $form->labelEx($model,'idestadoplan'); ?>
            		<?php 
            		      echo $form->dropDownList($model,'idestadoplan',array('1' => 'Activo', '0' => 'Inactivo'),
            		          array('empty' => '--Seleccione--','class'=>'form-control'));
            		?>            		
                  </div>
                </div>
      ...
      <div class="modal-footer">
        ...
        <?php echo CHtml::submitButton('Registrar',array('data-action'=>'LP','data-id'=> $model->idherramienta,'class'=>'btn btn-primary btn-procesar')); ?>
      </div>
      <?php $this->endWidget(); ?>
    </div><!-- /.modal-content -->
</div><!-- /.modal-dialog -->