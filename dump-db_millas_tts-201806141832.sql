...
INSERT INTO `configuracion` VALUES (1,'0752','1001','3','1.560,00');
...
INSERT INTO `cruge_user` VALUES (1,NULL,NULL,1528999321,'admin','edwinrzc@gmail.com','b2428a3aa2c94e57b85d731c87018419736070121659caec0ee841a24021e582b4f6402faef67cc84e75531ba1e8a8b45a19a8c0ff98fdfdf5fc0618fb301874',NULL,1,0,0),(2,NULL,NULL,NULL,'invitado','invitado','nopassword',NULL,1,0,0);
...
CREATE TABLE `pagos_promociones` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `pagos_promociones_UN` (`reference_id`),
...
-- Dump completed on 2018-06-14 18:32:58
