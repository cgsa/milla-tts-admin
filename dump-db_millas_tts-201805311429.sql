...
INSERT INTO `banner` VALUES (1,3,'Banner Promoción','Banner Promoción',NULL,1,NULL,'{\"contralador\":\"Promociones\",\"value\":\"1\"}');
...
INSERT INTO `cruge_authitem` VALUES ('action_banner_admin',0,'',NULL,'N;'),('action_banner_Update',0,'',NULL,'N;'),('action_destinos_admin',0,'',NULL,'N;'),('action_destinos_Create',0,'',NULL,'N;'),('action_destinos_Imagenes',0,'',NULL,'N;'),('action_destinos_Registrar',0,'',NULL,'N;'),('action_destinos_Update',0,'',NULL,'N;'),('action_destinos_view',0,'',NULL,'N;'),('action_estadoSistema_admin',0,'',NULL,'N;'),('action_estadoSistema_create',0,'',NULL,'N;'),('action_estadoSistema_update',0,'',NULL,'N;'),('action_estadoSistema_view',0,'',NULL,'N;'),('action_imagenes_admin',0,'',NULL,'N;'),('action_imagenes_Formulario',0,'',NULL,'N;'),('action_imagenes_Registrar',0,'',NULL,'N;'),('action_paises_admin',0,'',NULL,'N;'),('action_panelAdministrativo_index',0,'',NULL,'N;'),('action_promociones_admin',0,'',NULL,'N;'),('action_promociones_Create',0,'',NULL,'N;'),('action_promociones_Formulario',0,'',NULL,'N;'),('action_promociones_Imagenes',0,'',NULL,'N;'),('action_promociones_Registrar',0,'',NULL,'N;'),('action_promociones_Update',0,'',NULL,'N;'),('action_promociones_Upload',0,'',NULL,'N;'),('action_promociones_view',0,'',NULL,'N;'),('action_ui_fieldsadmincreate',0,'',NULL,'N;'),('action_ui_fieldsadminlist',0,'',NULL,'N;'),('action_ui_usermanagementadmin',0,'',NULL,'N;'),('action_ui_usermanagementupdate',0,'',NULL,'N;'),('edit-advanced-profile-features',0,'/var/www/html/milla-tts-admin/protected/modules/cruge/views/ui/usermanagementupdate.php linea 125',NULL,'N;'),('USER-AGENTE',0,'',NULL,'N;'),('USER-SISTEMA',0,'',NULL,'N;');
...
INSERT INTO `cruge_user` VALUES (1,NULL,NULL,1527768439,'admin','edwinrzc@gmail.com','b2428a3aa2c94e57b85d731c87018419736070121659caec0ee841a24021e582b4f6402faef67cc84e75531ba1e8a8b45a19a8c0ff98fdfdf5fc0618fb301874',NULL,1,0,0),(2,NULL,NULL,NULL,'invitado','invitado','nopassword',NULL,1,0,0);
...
INSERT INTO `destinos` VALUES (1,'Capital Federal','Buenos Aires','Buenos Aires fundada en 1500','-34.6131500, -58.3772300',NULL,0,'2018-05-29');
...
CREATE TABLE `galeria_destino` (
  ...
  CONSTRAINT `galeria_destino_destinos_FK` FOREIGN KEY (`id`) REFERENCES `destinos` (`id`),
...
INSERT INTO `galeria_promocion` VALUES (1,1,2,0),(2,1,3,0),(3,1,4,1),(4,1,5,0);
...
INSERT INTO `imagenes` VALUES (1,'726158-cayosombrero.jpg',NULL,NULL,NULL,0),(2,'526937-video-1-570x381.jpg',NULL,NULL,NULL,0),(3,'767184-typography-2-370x230.jpg',NULL,NULL,NULL,0),(4,'296268-typography-1-770x480.jpg',NULL,NULL,NULL,0),(5,'277684-services-3-370x254.jpg',NULL,NULL,NULL,0);
...
INSERT INTO `promociones` VALUES (1,1,'15000','12','2018-07-29',NULL,'nmnmnmkk76f54bhh6',1,0,1,'2018-07-31','2018-05-29 11:06:06');
...
-- Dump completed on 2018-05-31 14:29:03
